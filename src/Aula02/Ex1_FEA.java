...
public class Ex1_FEA {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("O seu burro "+e.getMessage() );
        }
